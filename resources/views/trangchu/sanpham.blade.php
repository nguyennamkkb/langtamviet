                    ...
                    <div class="row">
                     ...
                     <div class="col-12 col-sm-6 col-lg-4">
                        <div class="single-product-area mb-50">
                            <!-- Product Image -->
                            <div class="product-img1" style="max-width: 270px; margin: auto;">
                                <a href="s{{url('/post/singlepost/'.$tin->id)}}"><img src="{{url('uploads/tintuc/'.$tin->tieude.'/'.$tin->hinhanh1)}}" alt=""></a>
                                <!-- Product Tag -->
                            </div>
                            <!-- Product Info -->
                            <div class="product-info mt-15 text-center">
                                <a href="{{url('/post/singlepost/'.$tin->id)}}">
                                    <p style="font-size: 24px;font-weight: bold;">{{$tin->tieude}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
